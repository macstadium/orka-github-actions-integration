...
* The Orka GitHub runner has been tested with GitHub.com hosted environments. GitHub Enterprise Server was not available to the development team for testing, but given the runner was heavily inspired by the [ARC project](https://github.com/actions/actions-runner-controller), it is expected to work on GitHub Enterprise Server 3.6+
