...
func (client *ActionsClient) GenerateJitRunnerConfig(ctx context.Context, runnerScaleSet *types.RunnerScaleSet) (*types.RunnerScaleSetJitRunnerConfig, error) {
	path := fmt.Sprintf("/%s/%d/generatejitconfig", scaleSetEndpoint, runnerScaleSet.Id)
